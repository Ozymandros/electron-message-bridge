 ...
 *
 * Dynamic adapter loading utility for electron-ipc-helper.
 *
 * Optional adapter packages (e.g. `@electron-ipc-helper/adapter-assemblyscript`)
 ...
 * import { requireAdapter } from 'electron-ipc-helper/adapters/loader';
 *
 * const PACKAGE = '@electron-ipc-helper/adapter-my-runtime';
 *
 ...
 *   () => import('@electron-ipc-helper/adapter-assemblyscript'),
 * );
